...
void protobuf_AssignDesc_raw_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_raw_2eproto() {
  protobuf_AddDesc_raw_2eproto();
  ...
  static const int Unit_offsets_[33] = {
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_raw_2eproto);
}
...
void protobuf_ShutdownFile_raw_2eproto() {
...
void protobuf_AddDesc_raw_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_raw_2eproto() {
  static bool already_here = false;
  if (already_here) return;
  already_here = true;
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::SC2APIProtocol::protobuf_AddDesc_common_2eproto();
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_raw_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_raw_2eproto {
  StaticDescriptorInitializer_raw_2eproto() {
    protobuf_AddDesc_raw_2eproto();
  }
} static_descriptor_initializer_raw_2eproto_;
...
const StartRaw& StartRaw::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_raw_2eproto();
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[16 / 32] & 8323072u) {
    ZR_(is_flying_, is_burrowed_);
  }
  if (_has_bits_[24 / 32] & 3976200192u) {
